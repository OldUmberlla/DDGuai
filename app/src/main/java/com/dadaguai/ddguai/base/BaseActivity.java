...
import com.dadaguai.ddguai.utils.NetWorkStateReceiver;
 ...
 * _Umbrella
 */
public abstract class BaseActivity extends AutoLayoutActivity implements View.OnClickListener, NetWorkStateReceiver.onNetChanged {
    @Override
...
//    public static NetBroadcastReceiver.NetEvent event;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NetWorkStateReceiver.setOnNetChanged(this);
        preventCreateTwice();
        //禁止软键盘自动弹出
...
////            //无网络
////            toast("无网络");
////        } else if (mobileNetState == 0) {
////            //移动网络
////            toast("移动网络");
////        } else if (mobileNetState == 1) {
////            //WiFi
////            toast("WiFi");
////        }
//    }
