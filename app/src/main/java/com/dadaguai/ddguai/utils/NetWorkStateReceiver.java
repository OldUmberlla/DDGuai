...
public class NetWorkStateReceiver extends BroadcastReceiver {
    ...
    private final static String TAG = NetWorkStateReceiver.class.getName();
    public static onNetChanged netChanged;
    ...
    public static void setOnNetChanged(onNetChanged net) {
        netChanged = net;
    }
}
